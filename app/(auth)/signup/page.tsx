  ...
  return (
    <div style={{ width: "100%", maxWidth: 380 }}>
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 12, color: "#555", margin: 0 }}>Free forever · no credit card needed</p>
      </div>
      ...
      <div style={{ marginTop: 28, paddingTop: 24, borderTop: "1px solid #1c1c1c", fontSize: 12, color: "#555" }}>
        ...
        <Link href="/login" style={{ color: "#888", textDecoration: "none", borderBottom: "1px solid #3a3a3a", paddingBottom: 1 }}>
          Sign in →
        </Link>
      </div>
    </div>
